...
const Table = ({ columns, data, emptyMessage = 'Tidak ada data ditemukan.', className = '' }) => {
    ...
    if (!data || data.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center p-8 text-gray-500 bg-gray-50 border border-gray-200 rounded-lg">
    ...
    return (
        <div className={`overflow-x-auto shadow-md rounded-xl border border-gray-200 ${className}`}>
