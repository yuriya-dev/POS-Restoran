...
const Modal = ({ isOpen, onClose, title, children }) => {
    ...
    return (
        ...
        >
            ...
            <div 
                className="bg-white rounded-xl shadow-2xl w-full max-w-lg lg:max-w-xl p-6 transform transition-all duration-300 ease-in-out translate-y-0 opacity-100 scale-100"
