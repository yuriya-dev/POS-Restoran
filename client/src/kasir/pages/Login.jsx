...
import { UtensilsCrossed, AlertTriangle, Loader2, Moon, Sun } from 'lucide-react'; // Gunakan icon umum
...
const Login = () => {
  ...
  const handleRedirect = (role) => {
    if (role === 'admin') {
        // Sudah di Admin App, pakai navigate biasa
        navigate('/', { replace: true });
    } else if (role === 'kasir') {
        // Pindah ke Kasir App
        // Cek Environment: Jika Production (Vercel) pakai '/kasir', jika Local pakai port 5174
        const kasirUrl = import.meta.env.PROD ? '/kasir/' : 'http://localhost:5174';
        window.location.href = kasirUrl;
    }
  };
